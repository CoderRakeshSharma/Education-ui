  ...
  return (
    <div className="w-full bg-[#FDF8EE] border-b border-primary border-slate-600">
      <div className="flex flex-col md:flex-row">
        <div className="w-full mt-20 mb-20 ml-24 md:w-1/2 order-2 md:order-1">
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-bold mb-4">The
              <span className="text-orange"> Smart</span>
            </h2>
            <h2 className="text-3xl font-bold mb-4">Choice For
          ...
          <div className="flex items-center mt-4">
            ...
            <input
              ...
              className="border border-gray-300 px-4 py-2 rounded-full flex-grow"
            />
